                       ...
                       [[maybe_unused]] const ::services::StepTrigger& trigger)
{
    ...
    // which will trigger "on_load_snapshot_in" action
                           ...
                           const ::services::StepTrigger& trigger)
{
    ...
    if (trigger.type == ::services::StepTrigger::Type::LOGICAL_ACTION &&
        trigger.action_name == "on_load_snapshot_in")
    {
                          ...
                          const ::services::StepTrigger& trigger)
{
    ...
    if (trigger.type == ::services::StepTrigger::Type::LOGICAL_ACTION)
    {
        ...
        else if (trigger.action_name == "on_job_result_in")
        {
        ...
        else if (trigger.action_name == "on_query_request_in")
        {
        ...
        else if (trigger.action_name == "on_control_request_in")
        {
